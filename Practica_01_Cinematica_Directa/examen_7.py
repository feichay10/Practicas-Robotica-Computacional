...
T45_1 = matriz_T(d[4],th[4],a[4],al[4])
T05_1 = np.dot(T04,T45_1)    # Transformar del punto 5.1

T45_2 = matriz_T(d[5],th[5],a[5],al[5])
T05_2 = np.dot(T04, T45_2)   # Transformar del punto 5.2
