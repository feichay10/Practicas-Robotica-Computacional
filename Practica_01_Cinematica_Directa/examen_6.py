...
d  = [5,      0,      0,   0,     0,       0,    0,  0,  0]
th = [p[0],   0,     90,   0, -p[3],    p[3],   0,  0,  0]
a  = [0,   p[1],  -p[2],  -1,    -1,      -1,    0,  0,  0]
al = [90,     0,      0,   0,     0,       0,    0,  0,  0]
...
T04 = np.dot(T03,T34)       # del EE al 0

T34_1 = matriz_T(d[4],th[4],a[4],al[4])
T04_1 = np.dot(T03,T34_1)    # Transformar del punto 4.1

T34_2 = matriz_T(d[5],th[5],a[5],al[5])
T04_2 = np.dot(T03, T34_2)   # Transformar del punto 4.2

#T56_1 = matriz_T(d[6],th[6],a[6],al[6])
#T06_1 = np.dot(T05_1,T56_1)

#T56_2 = matriz_T(d[7],th[7],a[7],al[7])
#T06_2 = np.dot(T05_2,T56_2)

#T4_ef = matriz_T(d[8],th[8],a[8],al[8])
...
o50 =np.dot(T04_1, o55).tolist()
o60 =np.dot(T04_2, o66).tolist()


#o70 =np.dot(T06_1, o77).tolist()
#o80 =np.dot(T06_2, o88).tolist()
#o90 =np.dot(T0_ef, o99).tolist()
