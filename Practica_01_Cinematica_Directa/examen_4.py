...
# Parámetros D-H:
#        1     i      2         3                 4          51   52           ef
d  = [ p[0],     0,   p[1],         20,            -10,         0,    0,          0]
th = [    0,    90,     90,  -90-p[2],   -90 - p[3],  -90+p[4],   -90-p[4],  -90]
a  = [    0,     0,      0,         0,            0,         10,    10,     0,   10]
al = [    0,    90,      0,       -90,           90,         0,    0,     0,   0]
...
T1i=matriz_T(d[1],th[1],a[1],al[1])
Ti2=matriz_T(d[2],th[2],a[2],al[2])
...
muestra_origenes([o00,o10, oi0, o20, o30, o40, [[o510], [o520]]], oef0)
muestra_robot   ([o00,o10, oi0, o20, o30, o40, [[o510], [o520]]], oef0)
input()